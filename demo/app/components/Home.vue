<template>
    <Page ref="page">
        ...
        <AbsoluteLayout>
            ...
            <Fab position="right" title="test" iconClass="mdi" :icon="'mdi-plus' | fonticon" :iconOn="'mdi-share-variant' | fonticon" @tap="onTap('main', $event)">
                ...
                <FabItem title="test3" iconClass="mdi" icon="b" @tap="onTap('test3', $event)"/>
